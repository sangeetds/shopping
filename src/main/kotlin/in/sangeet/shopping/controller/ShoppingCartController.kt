...
class ShoppingCartController(private val shoppingService: ShoppingService) {
    ...
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200", description = "New cart created",
    ...
    fun createNewCart(@RequestParam userId: Long): ResponseEntity<Cart> =
        ResponseEntity.ok(shoppingService.createNewCart(userId))


    /**
     * Adds an item to the cart.
     *
     * @param userRequestDTO The request body containing all the details
    ...
    @PostMapping("/items")
    fun addItemToCart(@RequestBody userRequestDTO: UserRequestDTO): ResponseEntity<CartItem> {
        val cart = shoppingService.addItemToCart(
            userRequestDTO.userId,
            userRequestDTO.productId,
            userRequestDTO.quantity,
            userRequestDTO.cartId
        )
    ...
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200", description = "Item quantity updated",
                content = [Content(mediaType = "application/json", schema = Schema(implementation = CartItem::class))]
            ),
    ...
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200", description = "Item removed from cart",
    ...
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200", description = "Items retrieved",
                content = [Content(mediaType = "application/json", schema = Schema(implementation = CartItem::class))]
            ),
            ApiResponse(responseCode = "404", description = "Cart not found", content = [Content()]),
            ApiResponse(responseCode = "500", description = "Internal server error", content = [Content()])
    ...
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200", description = "Total price retrieved",
    ...
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200", description = "Cart checked out successfully",
                content = [Content(mediaType = "application/json")]
            ),
            ApiResponse(responseCode = "404", description = "Cart not found", content = [Content()]),
            ApiResponse(responseCode = "500", description = "Internal server error", content = [Content()])
